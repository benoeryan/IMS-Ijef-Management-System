...
function renderApp() {
  ...
  <div class="sidebar" id="sidebar">
    ...
    <div style="padding:16px 20px;border-top:1px solid rgba(255,255,255,.1)"><div style="font-size:.75rem;color:rgba(255,255,255,.5)">v11.7 (LATEST) — ${currentUser.nama}</div></div>
  </div>
  <div class="header">
