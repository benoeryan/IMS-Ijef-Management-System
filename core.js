...
function navigateTo(page) {
  ...
  const routes = {
    ...
    departemen: window.renderDepartemen,
    posisi: window.renderPosisi,
    cabang: window.renderCabang,
    karyawan: window.renderKaryawan,
    'struktur-org': window.renderStrukturOrg,
    onboarding: window.renderOnboarding,
    offboarding: window.renderOffboarding,
    'jobdesk-mgmt': window.renderJobdeskMgmt,
    lowongan: window.renderLowongan,
    pipeline: window.renderPipeline,
    kandidat: window.renderKandidat,
    absensi: window.renderAbsensiAdmin,
    cuti: window.renderCuti,
    overtime: window.renderOvertime,
    'hari-libur': window.renderHariLibur,
    penalty: window.renderPenalty,
    penggajian: window.renderPenggajian,
    'laporan-keuangan': window.renderLaporanKeuangan,
    'tax-calc': window.renderTaxCalc,
    insentif: window.renderInsentif,
    'system-admin': window.renderSystemAdmin,
    reimbursement: window.renderReimbursement,
    kasbon: window.renderKasbon,
    tunjangan: window.renderTunjangan,
    kpi: window.renderKPI,
    pelatihan: window.renderPelatihan,
    'disc-test': window.renderDiscTestPage,
    kontrak: window.renderKontrak,
    'legal-perizinan': window.renderLegalPerizinan,
    'legal-kajian': window.renderKajianHukum,
    'legal-sengketa': window.renderLegalSengketa,
    asset: window.renderAsset,
    peraturan: window.renderPeraturan,
    surat: window.renderSurat,
