...
const SEG1 = {
  D: [
    -6, -5.3, -4, -2.5, -1.7, -1.3, 0, 0.5, 1, 2, 3, 3.5, 4, 4.7, 5.3, 6.5, 7,
    7, 7, 7.5, 7.5,
  ],
  I: [
    -7, -4.6, -2.5, -1.3, 1, 3, 3.5, 5.3, 5.7, 6, 6.5, 7, 7, 7, 7, 7, 7.5, 7.5,
    7.5, 7.5, 8,
  ],
  S: [
    -5.7, -4.3, -3.5, -1.5, -0.7, 0.5, 1, 2.5, 3, 4, 4.6, 5, 5.7, 6, 6.5, 6.5,
    7, 7, 7, 7.5, 7.5,
  ],
  C: [
    -6, -4.7, -3.5, -1.5, 0.5, 2, 3, 5.3, 5.7, 6, 6.3, 6.5, 6.7, 7, 7.3, 7.3,
    7.3, 7.5, 8, 8, 8,
  ],
};
const SEG2 = {
  D: [
    7.5, 6.5, 4.3, 2.5, 1.5, 0.5, 0, -1.3, -1.5, -2.5, -3, -3.5, -4.3, -5.3,
    -5.7, -6, -6.5, -6.7, -7, -7.3, -7.5,
  ],
  I: [
    7, 6, 4, 2.5, 0.5, 0, -2, -3.5, -4.3, -5.3, -6, -6.5, -7, -7.2, -7.2, -7.2,
    -7.3, -7.3, -7.3, -7.5, -8,
  ],
  S: [
    7.5, 7, 6, 4, 2.5, 1.5, 0.5, -1.3, -2, -3, -4.3, -5.3, -6, -6.5, -6.7, -6.7,
    -7, -7.2, -7.3, -7.5, -8,
  ],
  C: [
    7.5, 7, 5.6, 4, 2.5, 1.5, 0.5, 0, -1.3, -2.5, -3.5, -5.3, -5.7, -6, -6.5,
    -7, -7.3, -7.5, -7.7, -7.9, -8,
  ],
};
...
const PROFILES = {
  ...
  "I-C": {
    ...
    neg: [
      "Kadang salah menilai kemampuan orang",
      "Terlalu optimis",
      "Kurang fokus saat tugas",
    ],
    career:
  ...
  "C-D-S": {
    ...
    neg: [
      "Terlalu fokus tugas",
      "Sensitif tapi tertutupi logika",
      "Kurang spontan",
    ],
    career:
  ...
  "C-I-S": {
    ...
    neg: [
      ...
      "Not Leader",
      "Work/Play Conflict",
      "Terlalu khawatir pendapat orang",
    ],
    career:
...
async function loadLowonganOptions() {
  try {
    ...
    if (snap.empty) {
      opts +=
        '<option value="General">General (Belum ada lowongan aktif)</option>';
    } else {
      snap.forEach((d) => {
        const p = d.data();
